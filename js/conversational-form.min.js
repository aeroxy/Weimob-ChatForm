...
(function(cf) {
  ...
  var Helpers = (function() {
    ...
    Helpers.getXYFromMouseTouchEvent = function(event) {
      var touches = null;
      if(event.originalEvent) touches = event.originalEvent.touches || event.originalEvent.changedTouches;
      else if(event.changedTouches) touches = event.changedTouches;
      if(touches) {
        return {
          x: touches[0].pageX,
          y: touches[0].pageY,
    ...
    //   }
    //   if(scriptSrc === void 0) {
    //     scriptSrc = "//cdnjs.cloudflare.com/ajax/libs/emojify.js/1.1.0/js/emojify.min.js";
    //   }
...
(function(cf) {
  ...
  var ControlElement = (function(_super) {
    ...
    Object.defineProperty(ControlElement.prototype, "highlight", {
      ...
      set: function(value) {
        if(value) this.el.classList.add("highlight");
        else this.el.classList.remove("highlight");
      },
      enumerable: true,
      configurable: true
    });
...
(function(cf) {
  var ControlElements = (function() {
    ...
    Object.defineProperty(ControlElements.prototype, "disabled", {
      set: function(value) {
        if(value) this.list.classList.add("disabled");
        else this.list.classList.remove("disabled");
      },
      enumerable: true,
      configurable: true
    });
      ...
      if(this.el.classList.contains("two-row")) {
        ...
        for(var i = 0; i < elements.length; i++) {
          ...
          if(element.visible) {
            ...
            if(element.positionVector.y < 30) this.tableableRows[0].push(element);
            else this.tableableRows[1].push(element);
          }
        }
      } else {
        // single row
...
(function(cf) {
  var ScrollController = (function() {
    ...
    ScrollController.prototype.render = function() {
      ...
      if(this.xTarget > 0) this.xTarget += (0 - this.xTarget) * cf.Helpers.lerp(ScrollController.accerlation, 0.3, 0.8);
      if(this.xTarget < this.max) this.xTarget += (this.max - this.xTarget) * cf.Helpers.lerp(ScrollController.accerlation, 0.3, 0.8);
...
(function(cf) {
  ...
  var Dictionary = (function() {
    function Dictionary(options) {
      ...
      if(options && options.data) this.data = this.validateAndSetNewData(options.data, this.data);
      // overwrite user image
      if(options.userImage) this.data["user-image"] = options.userImage;
      // overwrite robot image
      if(options.robotImage) this.robotData["robot-image"] = options.robotImage;
  ...
  var Tag = (function() {
    ...
    Object.defineProperty(Tag.prototype, "question", {
      get: function() {
        ...
        if(!this.questions || this.questions.length == 0) return cf.Dictionary.getRobotResponse(this.type);
        else return this.questions[Math.floor(Math.random() * this.questions.length)];
      },
      enumerable: true,
      configurable: true
    });
      ...
      get: function() {
        if(!this.errorMessages) {
          ...
          if(this.domElement.getAttribute("cf-error")) {
            ...
            if(this.type == "file") this.errorMessages = [cf.Dictionary.get("input-placeholder-file-error")];
            else {
      ...
      if(keys.length > 0) {
        ...
        for(var key in keys) {
          if(keys.hasOwnProperty(key)) {
            ...
            if(typeof(attr.name) !== 'undefined' && attr.name.indexOf("cf-conditional") !== -1) {
              // conditional found
              var _conditionals = [];
...
(function(cf) {
  ...
  var TagGroup = (function() {
    function TagGroup(options) {
      ...
      if(cf.ConversationalForm.illustrateAppFlow) console.log('Conversational Form > TagGroup registered:', this.elements[0].type, this);
    }
...
(function(cf) {
  ...
  var InputTag = (function(_super) {
    ...
    function InputTag(options) {
      var _this = _super.call(this, options) || this;
      if(_this.type == "text") {} else if(_this.type == "email") {} else if(_this.type == "tel") {} else if(_this.type == "checkbox") {} else if(_this.type == "radio") {} else if(_this.type == "password") {} else if(_this.type == "file") {
...
(function(cf) {
  ...
  var ButtonTag = (function(_super) {
    ...
    function ButtonTag(options) {
      var _this = _super.call(this, options) || this;
      if(_this.domElement.getAttribute("type") == "submit") {} else if(_this.domElement.getAttribute("type") == "button") {
...
(function(cf) {
  ...
  var OptionsList = (function() {
    ...
    OptionsList.prototype.dealloc = function() {
      ...
      while(this.elements.length > 0) this.elements.pop().dealloc();
      this.elements = null;
    };
    return OptionsList;
  }());
...
(function(cf) {
  ...
  var UploadFileUI = (function(_super) {
    ...
    UploadFileUI.prototype.getFilesAsString = function() {
      ...
      icon.innerHTML = cf.Dictionary.get("icon-type-file") + "'></img><br>" + this.fileName;
      // icon.innerHTML = cf.Dictionary.get("icon-type-file") + this.readerResult + "'></img><br>" + this.fileName;
...
(function(cf) {
  ...
  var UserInput = (function(_super) {
    ...
    UserInput.prototype.onKeyDown = function(event) {
      ...
      if(event.keyCode == cf.Dictionary.keyCodes["shift"]) this.shiftIsDown = true;
...
(function(cf) {
  ...
  var ChatResponse = (function(_super) {
    ...
    Object.defineProperty(ChatResponse.prototype, "disabled", {
      ...
      set: function(value) {
        if(value) this.el.classList.add("disabled");
    ...
    ChatResponse.prototype.setData = function(options) {
      ...
      setTimeout(function() {
        ...
        if(_this.isRobotReponse || options.response != null) {
          ...
          setTimeout(function() {
            return _this.el.classList.add("peak-thumb");
  ...
  var ChatList = (function(_super) {
    ...
    ChatList.prototype.scrollListTo = function(response) {
      ...
      try {
        ...
        setTimeout(function() {
          return scrollable_1.scrollTop = y_1;
        }, 100);
      } catch(e) {
...
(function(cf) {
  ...
  var FlowManager = (function() {
    ...
    FlowManager.prototype.startFrom = function(indexOrTag, ignoreExistingTags) {
      ...
      if(typeof indexOrTag == "number") this.step = indexOrTag;
      else {
        // find the index..
...
(function(cf_1) {
  var ConversationalForm = (function() {
    function ConversationalForm(options) {
      ...
      if(!isNaN(options.scrollAccerlation)) cf_1.ScrollController.accerlation = options.scrollAccerlation;
      ...
      if(this.formEl.getAttribute("cf-prevent-autofocus") == "") cf_1.UserInput.preventAutoFocus = true;
      ...
      if(Object.keys(groups).length > 0) {
        for(var group in groups) {
          if(groups[group].length > 0) {
            ...
            var isFieldsetValidForCF = function(tag) {
            ...
            for(var i = 0; i < groups[group].length; i++) {
              ...
              if(i == 0) tags.splice(tags.indexOf(tagToBeRemoved), 1, tagGroup);
              else tags.splice(tags.indexOf(tagToBeRemoved), 1);
            }
          }
        }
      }
    ...
    ConversationalForm.illustrateFlow = function(classRef, type, eventType, detail) {
      ...
      if(ConversationalForm.illustrateAppFlow) {
        ...
        // if(detail) console.log("** event flow detail:", detail);
      }
    };
    ...
    ConversationalForm.autoStartTheConversation = function() {
      if(cf.ConversationalForm.hasAutoInstantiated) return;
